    ...
    public void actionPerformed(ActionEvent e) {
        if (this.textField.getText().startsWith("/")) {
            if (this.textField.getText().substring(1).trim().equals("clear")) {
                ...
                if (param[0].equals(this.name)) {
                    this.chatArea.append(">> [You can't send a message to yourself] <<" + "\n");
                } else {
            ...
            else if (this.textField.getText().substring(1).startsWith("online")) {
                this.out.println("GOONLINE" + this.name);
            }

            else if (this.textField.getText().substring(1).startsWith("clearlogs")) {
